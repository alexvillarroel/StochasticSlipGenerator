...
#Job Description: NZ30sec bathymetry, Spherical Coordinates for code testing
 Total run time (Wall clock, seconds)           : 3600
 Time interval to Save Data    ( unit: sec )    : 60
...
#===============================================:===============================
 No. of FLT Planes (With fault_multi.ctl if >1) : 972
 Fault Rupture Time (seconds)                   : 0.0
 Faulting Option (0: Model; 1- Data;)           :   0
 Focal Depth                             (meter): 9380.029565141393
 Length of source area                   (meter): 10000.0
 Width of source area                    (meter): 10000.0
 Dislocation of fault plate              (meter): 0.49173357763424613
 Strike direction (theta)               (degree): 7.806937552855192
 Dip  angle       (delta)               (degree): 6.848364616108608
 Slip angle       (lamda)               (degree): 91.20035590741136
 Origin of Comp. Domain (Layer 01) (Lat, degree): -43.24
 Origin of Comp. Domain (Layer 01) (Lon, degree): 280.0
 Epicenter: Latitude                    (degree): -29.545004500450045
 Epicenter: Longitude                   (degree): 287.68086351969106
...
#===============================================:===============================
 ...
 Grid Size  (dx, sph:minute, cart:meter)        :     2.160000000000082
...
#===============================================:===============================
 ...
 Manning's Roughness Coef. (For fric.option=0)  :     0.013
 Layer Ouput Option? (0:Z+Hu+Hv;1:Z Only;2:NONE):     1
 GridSize Ratio of Parent layer to current layer:     119.99999998465228
 X_start                                        :  288.3468
 X_end                                          :  288.4842
 Y_Start                                        :  -33.0654
 Y_end                                          :  -32.9784
 File Name of Bathymetry Data                   : valpo4_salida.xyz
 Data Format Option (0-OLD;1-MOST;2-XYZ;3-ETOPO):     2
