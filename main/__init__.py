...
# funcion para cargar datos de modelo slab2.0
def load_files_slab2(rake=True):

    """
    Load data from the hayes 2018 slab2.0 model.
    Inputs: If you have and wanna load rake file does nothing
    if not, invoke function like load_file_slab2(False)
    """
    ...
    slabdep   = np.genfromtxt(directory+files[0], delimiter = ",") # se lee el archivo a un array
    # archivo de dip
    slabdip    = np.genfromtxt(directory+files[1], delimiter = ",") # se lee el archivo a un array
    # archivo de strike
    slabstrike = np.genfromtxt(directory+files[2], delimiter = ",") # se lee el archivo a un array
    ...
    ## rake
    if rake==True:
        slabrake   = np.genfromtxt(directory+files[3], delimiter = ",")
